...
<html lang="pt-br">
  ...
  <body class="text-center">
    <form class="form-signin" method="post" action="Model/cadastrar.php">
      ...
      <a href="login.php"><button class="btn btn-lg btn-primary btn-block" type="button">Login</button></a>
